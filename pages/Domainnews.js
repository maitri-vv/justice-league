...
const Domainnews = () => {
  ...
  <figure><img src="/images/kyc1.jpg" alt="warnpeace"/></figure>
  ...
  <div id="item2" className="max-w-md p-4 space-x-4 carousel-item bg-neutral rounded-box text-white">
  <div className="card w-96 glass">
  <figure><img src="/images/kyc2.jpg" alt="terror"/></figure>
  <div className="card-body">
  ...
  <div className="card w-96 glass">
  <figure><img src="/images/kyc3.jpg" alt="milit"/></figure>
  <div className="card-body">
  ...
  <div id="item4" className="max-w-md p-4 space-x-4 carousel-item bg-neutral rounded-box text-white">
  <div className="card w-96 glass">
  <figure><img src="/images/kyc4.jpg" alt="nuclear"/></figure>
  <div className="card-body">
  ...
  <div className="card w-96 glass">
  <figure><img src="/images/kyc5.jpg" alt="car!"/></figure>
  <div className="card-body">
  ...
  <div id="item6" className="max-w-md p-4 space-x-4 carousel-item bg-neutral rounded-box text-white">
  <div className="card w-96 glass">
  <figure><img src="/images/kyc6.jpg" alt="car!"/></figure>
  <div className="card-body">
  ...
  <div className="card w-96 glass">
  <figure><img src="/images/kyc7.jpg" alt="car!"/></figure>
  <div className="card-body">
  ...
  <div id="item8" className="max-w-md p-4 space-x-4 carousel-item bg-neutral rounded-box text-white">
  <div className="card w-96 glass">
  <figure><img src="/images/kyc8.jpg" alt="car!"/></figure>
  <div className="card-body">
...
<h2 className="items-center p-2 m-2 text-4xl font-bold text-center text-white bg-slate-900">
      FAQ
    </h2>
<div className='p-5 bg-slate-900'>
            ...
            <div className="collapse-content"> 
                <p> A: Anyone who is interested in learning about or contributing to the cause of peace and justice can benefit from our website.</p>
            </div>
            </div>
            <div tabIndex={0} className="text-center m-5 border collapse collapse-plus border-base-300 bg-base-100 rounded-box">
            <div className="text-xl font-medium collapse-title">
            What resources does the website provide?
            </div>
            <div className="collapse-content"> 
                <p>A: Our website provides a range of resources, including articles, news updates, educational materials, and opportunities to get involved in activism and advocacy efforts.</p>
            </div>
            </div>
            <div tabIndex={0} className="text-center m-5 border collapse collapse-plus border-base-300 bg-base-100 rounded-box">
            <div className="text-xl font-medium collapse-title">
            How can I get involved in promoting peace and justice?
            </div>
            <div className="collapse-content"> 
                <p>A: Our website provides a variety of ways to get involved, including volunteering, making donations, participating in advocacy campaigns, and attending events and protests.</p>
            </div>
        </div>
    <div tabIndex={0} className="text-center m-5 border collapse collapse-plus border-base-300 bg-base-100 rounded-box">
            <div className="text-xl font-medium collapse-title">
            ...
            <div className="collapse-content"> 
                <p>A: You can contact us through our online contact form or by emailing us directly at [justiceleague@gmail.com]. We strive to respond to all inquiries as quickly as possible.</p>
            </div>
        </div>
    </div>
    </div>
